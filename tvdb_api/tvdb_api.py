...
def main():
    import logging
    logging.basicConfig(level=logging.DEBUG)
    tvdb_instance = Tvdb(interactive=False, cache=False, banners=True)
    for bannerid in tvdb_instance[73244]['_banners']['season']['season'].keys():
        if tvdb_instance[73244]['_banners']['season']['season'][bannerid]['season'] == "9":
            print tvdb_instance[73244]['_banners']['season']['season'][bannerid].keys()
