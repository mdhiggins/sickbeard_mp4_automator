...
2. Set the MP4 variables to your desired output
    ...
    - `vremux-only` = True/False - when True the script will skip processing the file if the source video codec is different then the output codec.  Avoids doing unwanted conversions.
