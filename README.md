...
2. Rename `setup\autoProcess.ini.sample` to `autoProcess.ini` inside and place your `config` directory (or attempt to run the script which will generate a new config file if absent)
