...
2. Set the MP4 variables to your desired output
    ...
    - `h264-max-level` = set your max h264 level. Use the decimal format. Levels lower than the specified value, if otherwiseB appropriate, will be copied without transcoding. Example - `4.0`.
