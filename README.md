...
2. Set the MP4 variables to your desired output
    ...
    - `video-width` = allows you to downsize video resolution.  If source file exceeds the video-width it will be transcoded to the specified video-width.  Height/width ratio will be preserved.
